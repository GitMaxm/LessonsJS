...
// var teacherQuestion = interviewQuestion("учитель");
// teacherQuestion("Иван");

interviewQuestion("дизайнер")("Егор");
*/
...
Даже если функция была определена в друго родительской функции и родительсяка функция была выполнена и вернула значения. Контекст выполнения уходит, но остается VO (variable object) все равно остается в памяти, и описанная внутренняя функция имеет доступ к нему.

Scope Chain - это указатели на Variable Objects.

Внутренняя функция всегда имеет доступ к переменным и параметрам внешней функции. Даже когда внешняя функция выполнена и вернула значение.
*/
